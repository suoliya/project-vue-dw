        ...
        <div class="row">
              <div class="col-lg-12 getheight">
                  <div class="usl-top-box white-bg pd-20 no-border">
                      <div class="inline"><h1 class="f-black inline mr20" style="margin-top: 5px;">交易报表</h1></div>
                      <!--搜索-->
                  </div>
                ...
                <div class="pad20 white-bg margin0 clearfix pdtop-0">
                  ...
                  <el-table :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column label="充值笔数" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.rechargeCount }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="提现笔数" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.cashCount }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="转入游戏金额" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.gameRecharge/100 }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="转出游戏金额" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.gameCash/100 }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="转入游戏笔数" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.gameRechargeCount }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="转出游戏笔数" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.gameCashCount }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="总用户数" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.totalAccount }}</span>
                      </template>
                    </el-table-column>
                    <el-table-column label="今日注册用户" width="">
                      <template slot-scope="scope">
                        <span>{{ scope.row.todayAccount }}</span>
                      </template>
                    </el-table-column>
...
import {payReoprtList} from '../../service/getData'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      payReoprtList(this.listQuery).then((res) => {
